...
<Select.Root {disabled} {...restProps} type="single" name="timezone" bind:value>
  <Select.Trigger
    class={"bg-bw50 h-8 py-2 rounded-[10px] border border-bw600 dark:border-bw600 placeholder:text-bw500 dark:placeholder:text-bw500 text-bw950 dark:text-bw100 dark:bg-bw800 focus:outline-none " +
      classname}
  >
    {triggerContent}
  </Select.Trigger>
