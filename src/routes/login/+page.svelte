<script lang="ts">
  ...
  import LeftImage from "$lib/images/login/left_side_image.png";
...
>
  ...
  >
    <Card.Root class="mx-auto max-w-sm border-hidden">
      <Card.Header>
        <Card.Title class="dark:text-bw100 text-2xl mb-7">Login</Card.Title>
        <Card.Description
        ...
        <form method="post" action="{auth.baseurl}/local">
          <div class="grid gap-4">
            <div class="grid gap-2">
              <Label class="dark:text-bw100" for="email">Email</Label>
              <CustomInput
            ...
            <div class="grid gap-2">
              <div class="flex items-center">
                <Label class="dark:text-bw100" for="password">Password</Label>
